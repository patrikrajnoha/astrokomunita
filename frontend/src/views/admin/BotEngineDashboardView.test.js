...
describe('BotEngineDashboardView', () => {
  ...
  it('renders summary cards and bot table from overview payload', async () => {
    ...
    expect(wrapper.text()).toContain('Zobraziť aktivitu')
    expect(wrapper.text()).toContain('Čistenie príspevkov botov')
    expect(wrapper.text()).toContain('Zapnúť automatické mazanie')
  })
})
