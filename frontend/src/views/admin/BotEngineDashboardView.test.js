...
describe('BotEngineDashboardView', () => {
  ...
  it('renders summary cards and bot table from overview payload', async () => {
    ...
    expect(wrapper.text()).toContain('Zobrazit aktivitu')
    expect(wrapper.text()).toContain('Cistenie bot prispevkov')
    expect(wrapper.text()).toContain('Zapnut automaticke mazanie')
  })
})
