...
class RepairEventTranslationArtifactsCommandTest extends TestCase
{
    ...
    public function test_it_repairs_untranslated_perihelion_titles(): void
    {
        config()->set('translation.default_provider', 'libretranslate');
        config()->set('translation.fallback_provider', '');
        config()->set('translation.cache_enabled', false);
        ...
        $event = Event::query()->create([
            ...
            'start_at' => now(),
            'max_at' => now(),
            'short' => 'Mars at Perihelion: 1.38126 AU',
            'description' => 'Mars at Perihelion: 1.38126 AU occurs on 26.03.2026.',
            'source_name' => 'astropixels',
            'source_uid' => 'event-perihelion-1',
            'source_hash' => hash('sha256', 'event-perihelion-1'),
        ]);

        $candidate = EventCandidate::query()->create([
            'source_name' => 'astropixels',
            'source_url' => 'https://astropixels.test/almanac2026cet.html',
            'source_uid' => 'candidate-perihelion-1',
            'external_id' => 'candidate-perihelion-1',
            'stable_key' => 'candidate-perihelion-1',
            'source_hash' => hash('sha256', 'candidate-perihelion-1'),
            'title' => 'Mars at Perihelion: 1.38126 AU',
            'original_title' => 'Mars at Perihelion: 1.38126 AU',
            'translated_title' => 'Mars at Perihelion: 1.38126 AU',
            'description' => 'Mars at Perihelion: 1.38126 AU occurs on 26.03.2026.',
            'original_description' => 'Mars at Perihelion: 1.38126 AU occurs on 26.03.2026.',
            'translated_description' => 'Mars at Perihelion: 1.38126 AU occurs on 26.03.2026.',
            'type' => 'planetary_event',
            'max_at' => now(),
            'start_at' => now(),
            'short' => 'Mars at Perihelion: 1.38126 AU',
        ...
        $this->assertSame("Mars v perih\u{00E9}liu: 1.38126 AU", $event->title);
    }
}
