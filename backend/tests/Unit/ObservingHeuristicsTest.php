...
class ObservingHeuristicsTest extends TestCase
{
    public function test_humidity_labels_are_computed_correctly(): void
    {
        ...
        $this->assertSame('Zlé', ObservingHeuristics::humidity(90)['label']);
        $this->assertSame('Nedostupné', ObservingHeuristics::humidity(null)['label']);
    }
    ...
    public function test_air_quality_labels_use_pm25_then_pm10_fallback(): void
    {
        ...
        $this->assertSame('Zlé', ObservingHeuristics::airQuality(40.0, null)['label']);
        ...
        $this->assertSame('Zlé', ObservingHeuristics::airQuality(null, 80.0)['label']);
    }
