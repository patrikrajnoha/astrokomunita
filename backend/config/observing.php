...
return [
    ...
    'sky' => [
        ...
        'moon_phases_year_cache_ttl_minutes' => env('SKY_MOON_PHASES_YEAR_CACHE_TTL_MINUTES', 720),
        'moon_phases_last_known_ttl_hours' => env('SKY_MOON_PHASES_LAST_KNOWN_TTL_HOURS', 48),
        'moon_phases_precision_bucket_minutes' => env('SKY_MOON_PHASES_PRECISION_BUCKET_MINUTES', 1),
        'moon_overview_cache_ttl_minutes' => env('SKY_MOON_OVERVIEW_CACHE_TTL_MINUTES', 5),
        'moon_overview_cache_ttl_hours' => env('SKY_MOON_OVERVIEW_CACHE_TTL_HOURS', 1),
        'moon_overview_last_known_ttl_hours' => env('SKY_MOON_OVERVIEW_LAST_KNOWN_TTL_HOURS', 24),
        'moon_overview_precision_bucket_minutes' => env('SKY_MOON_OVERVIEW_PRECISION_BUCKET_MINUTES', 5),
        ...
        'moon_events_last_known_ttl_hours' => env('SKY_MOON_EVENTS_LAST_KNOWN_TTL_HOURS', 168),
        'moon_fallback_logging_enabled' => env('SKY_MOON_FALLBACK_LOGGING_ENABLED', true),
        'moon_fallback_log_sample_rate' => env('SKY_MOON_FALLBACK_LOG_SAMPLE_RATE', 1.0),
        'moon_fallback_counter_enabled' => env('SKY_MOON_FALLBACK_COUNTER_ENABLED', true),
        'moon_fallback_counter_ttl_hours' => env('SKY_MOON_FALLBACK_COUNTER_TTL_HOURS', 240),
        ...
        'iss_aux_timeout_seconds' => env('SKY_ISS_AUX_TIMEOUT_SECONDS', 6),
        'iss_tracker_timeout_seconds' => env('SKY_ISS_TRACKER_TIMEOUT_SECONDS', 10),
        'light_pollution_cache_ttl_hours' => env('SKY_LIGHT_POLLUTION_CACHE_TTL_HOURS', 24),
        'light_pollution_last_known_ttl_hours' => env('SKY_LIGHT_POLLUTION_LAST_KNOWN_TTL_HOURS', 168),
    ...
    'providers' => [
        ...
        'open_meteo_geocoding_url' => env('OPEN_METEO_GEOCODING_URL', 'https://geocoding-api.open-meteo.com/v1/search'),
        'iss_pass_url' => env('ISS_PASS_PROVIDER_URL', 'http://api.open-notify.org/iss-pass.json'),
        'iss_tracker_url' => env('ISS_TRACKER_PROVIDER_URL', 'https://api.wheretheiss.at/v1/satellites/25544'),
        'celestrak_gp_url' => env('CELESTRAK_GP_URL', 'https://celestrak.org/NORAD/elements/gp.php'),
