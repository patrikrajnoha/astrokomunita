...
return [
    ...
    'providers' => [
        ...
        'openaq_locations_url' => env('OPENAQ_LOCATIONS_URL', 'https://api.openaq.org/v3/locations'),
        'openaq_latest_url' => env('OPENAQ_LATEST_URL', 'https://api.openaq.org/v3/locations/{id}/latest'),
    ],
