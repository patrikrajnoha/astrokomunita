...
return [
    ...
    'blog_tag_suggestion' => [
        'model' => env('AI_BLOG_TAG_SUGGESTION_MODEL', env('EVENTS_AI_MODEL', env('OLLAMA_MODEL', 'mistral'))),
        ...
        'retry_backoff_base_ms' => (int) env(
            ...
            env('EVENTS_AI_RETRY_BACKOFF_BASE_MS', env('OLLAMA_RETRY_BACKOFF_BASE_MS', 250))
        ),
    ],
