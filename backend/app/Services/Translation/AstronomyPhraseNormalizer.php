...
class AstronomyPhraseNormalizer
{
    ...
    private const SK_PATTERNS = [
        ...
        '/\b([\pL][\pL\-]*(?:\s+[\pL][\pL\-]*){0,3})(?:\s+\([A-Z]{2,5}\))?\s+meteor\s+sprcha\b/iu' => "Meteorick\u{00FD} roj \$1",
        '/\b([\pL][\pL\-]*(?:\s+[\pL][\pL\-]*){0,3})(?:\s+\([A-Z]{2,5}\))?\s+meteorick[^\s]*\s+sprcha\b/iu' => "Meteorick\u{00FD} roj \$1",
        '/\b([\pL][\pL\-]*(?:\s+[\pL][\pL\-]*){0,3})(?:\s+\([A-Z]{2,5}\))?\s+meteor(?:ic)?\s+shower\b/iu' => "Meteorick\u{00FD} roj \$1",
        '/\b([\pL][\pL\-]*(?:\s+[\pL][\pL\-]*){0,3})(?:\s+\([A-Z]{2,5}\))?\s+meteorick(?:\x{00FD}|y)\s+roj\b(?=$|[.,;:!?])/iu' => "Meteorick\u{00FD} roj \$1",
        ...
        '/\bmeteorick[^\s]*\s+sprcha\b/iu' => "meteorick\u{00FD} roj",
        '/\bmeteor\s+sprcha\b/iu' => "meteorick\u{00FD} roj",
